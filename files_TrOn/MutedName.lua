...
database:sadd(bot_id.."TrOn:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."TrOn:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_TrOn = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_TrOn then 
names_TrOn = database:smembers(bot_id.."TrOn:blocname"..msg.chat_id_) or ""
if names_TrOn and names_TrOn[1] then 
for i=1,#names_TrOn do 
if name_TrOn:match("(.*)("..names_TrOn[i]..")(.*)") then 
